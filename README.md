...
This repository contains code and experiment artifacts for the 13th IEEE International Conference on Data Science and Advanced Analytics (DSAA’2026) submission/paper on **profiling student programming behavior** and **predicting learner types** from time-ordered code snapshots, engineered behavioral features, and (optionally) embeddings.
